...
public sealed class CommandManagerService : IDisposable
{
        ...
        ApiController apiController, MareMediator mediator, MareConfigService mareConfigService)
    {
        ...
        {
            HelpMessage = "Opens the FormaShift UI" + Environment.NewLine + Environment.NewLine +
                ...
                "\t /sync toggle on|off - Connects or disconnects to FormaShift respectively" + Environment.NewLine +
                "\t /sync gpose - Opens the FormaShift Character Data Hub window" + Environment.NewLine +
                "\t /sync analyze - Opens the FormaShift Character Data Analysis window" + Environment.NewLine +
                "\t /sync settings - Opens the FormaShift Settings window"
        });
    }
