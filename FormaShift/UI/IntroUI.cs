...
public partial class IntroUi : WindowMediatorSubscriberBase
{
    ...
    public IntroUi(ILogger<IntroUi> logger, UiSharedService uiShared, MareConfigService configService,
        ...
        PerformanceCollectorService performanceCollectorService, DalamudUtilService dalamudUtilService) : base(logger, mareMediator, "FormaShift Setup", performanceCollectorService)
    {
        _uiShared = uiShared;
    ...
    protected override void DrawInternal()
    {
        ...
        {
            _uiShared.BigText("Welcome to FormaShift");
            ImGui.Separator();
            UiSharedService.TextWrapped("FormaShift is a plugin that will replicate your full current character state including all Penumbra mods to other paired Mare Synchronos users. " +
