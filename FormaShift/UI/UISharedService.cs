...
using FormaShift.Utils;
using Microsoft.Extensions.Logging;
using FormaShift.FileCache;
using FormaShift.Interop.Ipc;
using FormaShift.Localization;
...
using FormaShift.WebAPI;
using FormaShift.WebAPI.SignalR;
...
public partial class UiSharedService : DisposableMediatorSubscriberBase
{
    ...
    public void DrawCacheDirectorySetting()
    {
        ...
        {
            ColorTextWrapped("Your selected directory has files or directories inside that are not FormaShift related. Use an empty directory or a previous Mare storage directory only.", ImGuiColors.DalamudRed);
        }
    ...
    public bool DrawOtherPluginState()
    {
        ...
        {
            ImGui.TextColored(ImGuiColors.DalamudRed, "You need to install both Penumbra and Glamourer and keep them up to date to use FormaShift.");
            return false;
        }
