...
using FormaShift.API.Data.Comparer;
...
using FormaShift.WebAPI.Files.Models;
...
public class SettingsUi : WindowMediatorSubscriberBase
{
    ...
    public SettingsUi(ILogger<SettingsUi> logger,
        ...
        DalamudUtilService dalamudUtilService, HttpClient httpClient) : base(logger, mediator, "FormaShift Settings", performanceCollector)
    {
